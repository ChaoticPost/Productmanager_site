...
const BrandIcon: React.FC<BrandIconProps & { title: string; path: string }> = ({
  size = 22,
  className,
  title,
  path,
...
/** Brand marks via Simple Icons (monochrome / currentColor) */
export const FigmaBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Figma"
...
export const MiroBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Miro"
...
export const PowerBiBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Power BI"
...
export const JiraBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Jira"
...
export const ConfluenceBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Confluence"
...
export const PowerPointBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="PowerPoint"
...
export const ExcelBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Excel"
...
export const AnytypeBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Anytype"
...
export const FramerBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Framer"
...
export const NotionBrandIcon: React.FC<BrandIconProps> = (props) => (
  <BrandIcon
    {...props}
    title="Notion"
...
export const YandexFormsIcon: React.FC<BrandIconProps> = ({ size = 22, className }) => (
  <HugeiconsIcon
    icon={FormIcon}
    size={size}
    color="currentColor"
...
export const caseToolIconMap: Record<string, React.FC<BrandIconProps>> = {
  anytype: AnytypeBrandIcon,
  'yandex-forms': YandexFormsIcon,
...
export const stackIconMap = [
  { id: 'figma', label: 'Figma', Icon: FigmaBrandIcon },
  { id: 'miro', label: 'Miro', Icon: MiroBrandIcon },
  { id: 'powerbi', label: 'Power BI', Icon: PowerBiBrandIcon },
  { id: 'jira', label: 'Jira', Icon: JiraBrandIcon },
  { id: 'confluence', label: 'Confluence', Icon: ConfluenceBrandIcon },
  { id: 'powerpoint', label: 'PowerPoint', Icon: PowerPointBrandIcon },
  { id: 'excel', label: 'Excel', Icon: ExcelBrandIcon },
] as const;
